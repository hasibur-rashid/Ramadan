...
class ZakatInfoDetails extends React.Component {
    ...
    render() {
        ...
        const items = data.params.zakatInfoList;
            ...
            <View style={styles.container}>
                <View style={{ marginBottom: 20, backgroundColor: '#ffffff' }}>
                    ...
                    < ScrollView style={{ padding: 10 }}>
                        {this.adShow()}
                    {/* <Text style={{ fontSize: 16, fontWeight: 'normal', color:"black", textAlign: 'left', padding: 10 }}>{data.params.details}</Text> */}
...
export default ZakatInfoDetails;